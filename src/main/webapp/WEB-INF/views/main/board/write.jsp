...
<table class="board_tbl">
	<tr>
		<td>작성자명</td>
		<td align="left">
			<input name="name" type="text" value="" style="width:100%;" />
		</td>
	</tr>
	<tr>
		<td>제목</td>
		<td align="left">
			<input name="subject" type="text" value="" style="width:100%;"/>		
		</td>
	</tr>
	<tr>
		<td>내용</td>
		<td align="left">
			<textarea name="memo" cols="40" rows="10" style="width:100%;"></textarea>
		</td>
	</tr>
	<tr>
		<td>첨부(Attachments)</td>
		<td align="left">
			<input type="file" name="mediaFile" placeholder="파일 선택" multiple /><br/>
